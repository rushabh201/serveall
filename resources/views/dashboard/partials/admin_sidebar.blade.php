        ...
        <script>
            ...
            $(document).ready(function() {
                // var rushi =  $("#sidebar ul.menu-categories li.menu a").attr("href");
                // if ($("#sidebar ul.menu-categories li.menu a").attr('href') == window.location.pathname) {
                //     $("#sidebar ul.menu-categories li.menu a").closest('.menu').addClass('active');
                //     $("#sidebar ul.menu-categories li.menu a").closest('.submenu').addClass('collapsed show');
                //     $("#sidebar ul.menu-categories li.menu a").parent('li').addClass('active');
                // };

                $("#sidebar ul.menu-categories li.menu a").each(function() {
                    // var rushi = jQuery(this).attr("href");
                    // if( rushi  == window.location.pathname) {
                    //     $(this).closest('.menu').addClass('active');
                    //     $(this).closest('.submenu').addClass('collapsed show');
