                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                        ...
                        <div class="col-lg-12 margin-tb form-head pt-3">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-primary mr-2" href="{{ route('users.create') }}"> Add User </a>
                            ...
                            <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-dark btn-sm"><a href="{{ route('users.show',$user->id) }}" style="color:white;">Open</a></button>
